...
urlpatterns = patterns('',
    ...
    url('^save_data_status/$', 'hermes.results.save_data_status', name="save_data_status"),
    url('^stops/$', 'hermes.various.stops', name="stops"),
    url('^get_stops/$', 'hermes.various.get_stops', name="get_stops")
)
